...
public class RefreshListView extends ListView {
	...
	private void initHeader() {
		...
		tvLastUpdateTime = (TextView) headerView
				.findViewById(R.id.tv_last_update_time);
		 ...
		 * LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, 500);
		 * imageView.setLayoutParams(params);
		 * imageView.setImageResource(R.drawable
		 * .common_listview_headview_red_arrow); addHeaderView(imageView);
		 */
	...
	/**
	 * 解决ListView+ViewPager滑动冲突 横向滑动ViewPager时，稍微上下偏移ViewPager就会失去焦点
	 */
	@Override
