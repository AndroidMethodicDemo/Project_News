...
public class RefreshListView extends ListView {
	...
	private void initHeader() {
		...
		android.view.ViewGroup.LayoutParams params=new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, 500);
		imageView.setLayoutParams(params);
		imageView.setImageResource(R.drawable.common_listview_headview_red_arrow);
